...
CREATE TABLE tbl_CandidateMaster (
    ...
    CandidateCode                   NVARCHAR(20)  NOT NULL UNIQUE,   -- Unique alphanumeric, auto-generated by backend
    FirstName                       NVARCHAR(100) NOT NULL,
    LastName                        NVARCHAR(100) NOT NULL,
    Email                           NVARCHAR(200) NOT NULL,
    Phone                           NVARCHAR(20)  NULL,
    CompanyID                       INT           NOT NULL,           -- FK - Company reference
    BusinessUnitID                  INT           NOT NULL,           -- FK - Unit reference
    UniqueLink                      NVARCHAR(500) NULL,               -- URL sent to candidate (contains CandidateCode)
    Validity                        DATETIME      NULL,               -- Link expiry date/time
    Status                          NVARCHAR(50)  NOT NULL DEFAULT 'Pending',
                                                  -- Pending | Submitted | Verified
                                                  -- Security Manager Approved | Completed | Cancelled
    HRVerificationBy                INT           NULL,               -- FK → UserMaster
    HRVerifiedDate                  DATETIME      NULL,
    SecurityManagerApprovalBy       INT           NULL,               -- FK → UserMaster
    SecurityManagerApprovalDate     DATETIME      NULL,
    SecurityOfficerApprovalBy       INT           NULL,               -- FK → UserMaster
